...
public final class Functions {
    ...
    //double escaffer6_func (double[] , double , int , double[] ,double[] ,int ,int) /* Expanded ScafferÂ¡Â¯s
    ...
    public final static double sphere_func(double[] x, int nx) /* Sphere  */ {
        double f = 0.0;
...
//       double [] z = ShiftRotation.sr_func(x, nx, Os, Mr, 5.12 / 100.0, s_flag, r_flag);/*shift and rotate*/
    ...
    public final static double escaffer6_func(double[] x, int nx, double[] Os, double[] Mr, int s_flag, int r_flag) /* Expanded ScafferÂ¡Â¯s F6  */ {
        double temp1, temp2;
